      ...
      <form onSubmit={handleSaveEvent}>
        ...
        <div className="mb-4 flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="isAllDay" className="text-gray-700 font-medium">
            All Day Event
          </label>
        </div>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            onChange={handleInputChange}
            className="w-full p-1 h-10 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="w-16 p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 mr-2"
                    />
                    <select
        ...
        {!isNewEvent && (
          <div className="mb-6 border-t pt-4">
            ...
            {reminders.length > 0 && (
              <div className="mb-4">
                <h3 className="text-sm font-medium mb-2 text-gray-500">CURRENT REMINDERS</h3>
                <ul className="space-y-2">
                  {reminders.map(reminder => (
                    <li key={reminder.id} className="flex justify-between items-center p-2 bg-gray-50 rounded">
                      <span>
